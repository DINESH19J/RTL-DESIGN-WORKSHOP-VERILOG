# 🧠 WEEK 2 — RTL Simulation, Synthesis & Logic Optimization

> A practical exploration of RTL simulation, logic synthesis, optimization, gate-level simulation, latch inference, and parameterized Verilog design.

---

## 📌 Overview

Week 2 focuses on understanding how **Verilog RTL code is simulated, synthesized, optimized, and verified at gate level**.

The experiments demonstrate how different RTL coding styles affect the final synthesized hardware.
...
- RTL Sensitivity List Issues
- Unintended Latch Inference
- Complete and Incomplete `if` Statements
- Complete and Incomplete `case` Statements
- Parameterized `generate` Constructs
- Multiplexer and Demultiplexer Generation
...
- [1. Week 2 Objectives](#1-week-2-objectives)
- [2. D Flip-Flop with Asynchronous Reset](#2-d-flip-flop-with-asynchronous-reset)
- [3. Gate-Level Synthesis](#3-gate-level-synthesis)
- [4. Combinational Logic Optimization](#4-combinational-logic-optimization)
- [5. Sequential Logic Optimization](#5-sequential-logic-optimization)
- [6. Counter Logic Optimization](#6-counter-logic-optimization)
- [7. Ternary Operator MUX](#7-ternary-operator-mux)
- [8. Gate-Level Simulation](#8-gate-level-simulation)
- [9. RTL Sensitivity List Bug](#9-rtl-sensitivity-list-bug)
- [10. Unintended Latch — Incomplete `if`](#10-unintended-latch--incomplete-if)
- [11. Unintended Latch — Incomplete `case`](#11-unintended-latch--incomplete-case)
- [12. Corrected Complete `case` Statement](#12-corrected-complete-case-statement)
- [13. Partial Case Assignment](#13-partial-case-assignment)
- [14. Parameterized MUX Using Generate](#14-parameterized-mux-using-generate)
- [15. Generated 1-to-8 Demultiplexer](#15-generated-1-to-8-demultiplexer)
- [16. 8-bit Ripple Carry Adder](#16-8-bit-ripple-carry-adder)
- [17. Key Observations](#17-key-observations)
- [18. Tools and Technologies](#18-tools-and-technologies)
- [19. Overall Week 2 Flow](#19-overall-week-2-flow)
...
The main objective of Week 2 is to understand the relationship between:
